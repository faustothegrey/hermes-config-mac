...
§
HMP failover 2026-09-23: Charon peer70 down (656 fallimenti), Sidecar peer58→primario, poi RECOVERY (health check 200). Radice: watchdog sync su nodo REMOTO peer58/Sidecar, non locale. Verifica flapping: 1 health check, poi standby. Mesh A2A: POST /v1/runs su peer128 porta 8642 (NON 8765); Bearer 64char da dotenv.
§
