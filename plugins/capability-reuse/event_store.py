...
def emit_harness_decision(
    *,
    ...
    """Record the authoritative operation-specific pre-tool reuse decision."""
    payload = {
    ...
    return emit("harness_decision_event", payload, context=context or {})
...
def emit_surface_execution_start(execution_surface: str = "hmp_plugin",
                                 ...
                                 producer_surface: str = "", provenance: str | None = None,
                                 provenance_detail: str = "", provenance_source: str = "",
                                 collector_peer_id: str = ""):
